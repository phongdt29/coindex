...
Route::namespace('Frontend')->group(function () {
    ...
    Route::post('/','TrangchuController@loadDataAjax' )->name('trangchupost');
   /* Route::post('/','TrangchuController@postlienhe')->name('postlienhe');*/
    Route::get('{slug}.html','TrangchuController@theloai')->name('theloai');
    Route::get('abc/{slug}.html','TrangchuController@chitiet')->name('chitiet');
    Route::get('search/tu-khoa/{keyword}','TrangchuController@timkiem')->name('Frontend.Search');
    Route::post('tim-kiem','TrangchuController@search')->name('Frontend.Timkiem');

    Route::get('abc/Tags/{tag}.html','TrangchuController@tags')->name('tags');
    Route::post('tim-kiem/san-pham','TrangchuController@search_pro')->name('search_pro');
 	Route::get('/ajax','TrangchuController@ajaxHome' )->name('ajax-home');
